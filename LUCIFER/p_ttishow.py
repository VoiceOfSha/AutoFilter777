    ...
    if temp.ME in r_j_check:
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                buttons = [[
                InlineKeyboardButton("ʀᴇᴀᴅ ɢʀᴏᴜᴘ ʀᴜʟᴇs 📌", url="https://telegra.ph/How-to-get-movies--series-from-Bot-12-28")
            ]]
                ...
                photo="https://telegra.ph/file/d1b6d85859805737c14b0.jpg",
